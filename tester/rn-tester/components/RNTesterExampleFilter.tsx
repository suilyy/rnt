...
class RNTesterExampleFilter extends React.Component {
  ...
  render() {
    ...
    const filter = example => {
      ...
      return this.props.disableSearch || this.props.filter({ example, filterRegex, category });
    };
          ...
          return (
            <View
              style={[
                ...
                {
                  backgroundColor:
                    Platform.OS === 'ios' ? theme.SystemBackgroundColor : theme.BackgroundColor,
                },
              ]}>
              ...
              {!this.props.hideFilterPills && (
                <RNTesterListFilters
                  onFilterButtonPress={filterLabel => this.setState({ category: filterLabel })}
                />
              )}
            </View>
          );
...
export default RNTesterExampleFilter;
