...
export const displayName = 'recyclerlistview';
export const framework = 'React';
export const category = 'basic';
export const title = 'recyclerlistview';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/recyclerlistview.md';
export const description = 'recyclerlistview';

export const examples = [
    {
        title: 'recyclerlistview',
        render: function (): any {
            return <RecyclerListViewTestDemo />;
        },
    },
];
