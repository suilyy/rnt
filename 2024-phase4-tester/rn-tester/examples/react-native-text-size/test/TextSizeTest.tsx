...
export const displayName = 'react-native-text-size';
export const framework = 'React';
export const category = 'baisc';
export const title = 'react-native-text-size';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-text-size.md';
export const description = 'react-native-text-size';

export const examples = [
  {
    title: 'react-native-text-size',
    render: function (): any {
      return <TextSize />;
    },
  },
