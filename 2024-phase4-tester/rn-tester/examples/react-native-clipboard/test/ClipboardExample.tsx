...
export const displayName = 'react-native-clipboard';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-clipboard';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-clipboard-clipboard.md'
export const description = 'react-native-clipboard';

export const examples = [
    {
        title: 'react-native-clipboard',
        render: function (): any {
