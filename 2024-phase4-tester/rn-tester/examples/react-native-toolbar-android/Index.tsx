...
export const displayName = 'toolbar-android';
export const framework = 'React';
export const category = 'UI';
export const title = 'toolbar-android';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-community-toolbar-android.md';
export const description = 'toolbar-android';
