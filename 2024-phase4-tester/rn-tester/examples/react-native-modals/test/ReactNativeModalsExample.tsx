...
export const displayName = 'react-native-modals';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-modals';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-modals.md';
export const description = 'react-native-modals';
