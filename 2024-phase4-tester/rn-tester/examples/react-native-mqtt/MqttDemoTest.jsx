...
export const displayName = 'react-native-mqtt';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-mqtt';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-mqtt.md';
export const description = 'react-native-mqtt';
