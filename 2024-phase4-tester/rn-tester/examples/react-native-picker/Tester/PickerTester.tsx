...
export const displayName = 'react-native-picker';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-picker';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-picker.md';
export const description = 'react-native-picker';
