...
export const displayName = 'react-native-community-segmented-control';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-community-segmented-control';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-community-segmented-control.md';
export const description = 'segmented-control';

export const examples = [
    {
        title: 'react-native-community-segmented-control',
        render: function (): any {
            return <T_SegmentedControl />;
        },
    },
];
