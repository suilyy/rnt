...
export const displayName = 'react-native-modalbox';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-modalbox';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-modalbox.md';
export const description = 'react-native-modalbox';
