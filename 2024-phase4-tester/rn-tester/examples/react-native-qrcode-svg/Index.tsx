...
export const displayName = 'QrcodeSvgDemo';
export const framework = 'React';
export const category = 'basic';
export const title = 'QrcodeSvgDemo';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-qrcode-svg.md';
export const description = 'react-native-qrcode-svg';

export const examples = [
    {
        title: 'react-native-qrcode-svg',
        render: function (): any {
            return <QrcodeSvgDemo />;
        },
    },
];
