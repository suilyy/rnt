...
export const displayName = 'TransitiongroupExample';
export const framework = 'React';
export const category = 'basic';
export const title = 'TransitiongroupExample';
...
export const description = 'TransitiongroupExample';

export const examples = [
    {
        title: 'TransitiongroupExample',
        render: function (): any {
            return <TransitiongroupExample />;
        },
    },
];
