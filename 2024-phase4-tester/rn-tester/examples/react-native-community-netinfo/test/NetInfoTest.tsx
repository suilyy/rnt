...
export const displayName = 'react-native-community-netinfo';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-community-netinfo';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-community-netinfo.md';
export const description = 'react-native-community-netinfo';
