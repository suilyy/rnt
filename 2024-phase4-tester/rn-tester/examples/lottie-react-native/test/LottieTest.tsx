...
export const displayName = 'lottie-react-native';
export const framework = 'React';
export const category = 'basic';
export const title = 'lottie-react-native';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/lottie-react-native.md';
export const description = 'lottie-react-native';
