...
export const displayName = 'react-subscribe';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-subscribe';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-subscribe.md';
export const description = 'react-subscribe';

export const examples = [
    {
        title: 'react-subscribe',
        render: function (): any {
            return <ReactSubscribeTest />;
        },
    },
];
