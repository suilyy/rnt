...
export const displayName = 'geolocation';
export const framework = 'React';
export const category = 'basic';
export const title = 'geolocation';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-community-geolocation.md';
export const description = 'geolocation';
