...
export const displayName = 'react-native-reanimated-carousel';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-reanimated-carousel';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-reanimated-carousel.md';
export const description = 'react-native-reanimated-carousel';

export const examples = [
  {
    title: 'react-native-reanimated-carousel',
    render: function (): any {
      return <ReanimatedCarouselExample />;
    },
  },
];
