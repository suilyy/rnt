...
export const displayName = 'TestRenderHtml';
export const framework = 'React';
export const category = 'basic';
export const title = 'TestRenderHtml';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-render-html.md';
export const description = 'TestRenderHtml';

export const examples = [
    {
        title: 'TestRenderHtml',
        render: function (): any {
            return <TestRenderHtml />;
        },
    },
];