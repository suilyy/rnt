...
export const displayName = 'react-native-permission';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-permission';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-permissions.md';
export const description = 'react-native-permission';

export const examples = [
    {
        title: 'react-native-permission',
        render: function (): any {
