...
export const displayName = 'react-native-md5';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-md5';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-md5.md';
export const description = 'react-native-md5';

export const examples = [
    {
        title: 'react-native-md5',
        render: function (): any {
            return <Md5TestExample />;
        },
    },
];
