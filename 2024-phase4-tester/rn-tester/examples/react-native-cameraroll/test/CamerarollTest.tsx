...
export const displayName = 'react-native-cameraroll';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-cameraroll';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-cameraroll.md';
export const description = 'react-native-cameraroll';
