...
export const displayName = 'react-native-tab-view';
export const framework = 'React';
export const category = 'baisc';
export const title = 'react-native-tab-view';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-tab-view.md';
export const description = 'react-native-tab-view';

export const examples = [
  {
    title: 'react-native-tab-view',
    render: function (): any {
      return <NewTabViewExample />;
    },
  },
];
