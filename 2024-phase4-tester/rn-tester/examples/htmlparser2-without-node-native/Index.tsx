...
export const displayName = 'HtmlParser2Test';
export const framework = 'React';
export const category = 'basic';
export const title = 'HtmlParser2Test';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/htmlparser2.md';
export const description = 'HtmlParser2Test';

export const examples = [
    {
        title: 'HtmlParser2Test',
        render: function (): any {
            return <HtmlParser2Test />;
        },
    },
];
