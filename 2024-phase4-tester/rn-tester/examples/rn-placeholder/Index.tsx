...
export const displayName = 'RnPlaceholderTest';
export const framework = 'React';
export const category = 'UI';
export const title = 'RnPlaceholderTest';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/rn-placeholder.md';
export const description = 'RnPlaceholderTest';

export const examples = [
    {
        title: 'RnPlaceholderTest',
        render: function (): any {
            return <RnPlaceholderTest />;
        },
    },
];
