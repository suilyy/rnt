...
export const displayName = 'react-native-tab-navigator';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-tab-navigator';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-tab-navigator.md';
export const description = 'react-native-tab-navigator';
