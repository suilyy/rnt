...
export const displayName = 'react-native-pickers';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-pickers';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-pickers.md';
export const description = 'react-native-pickers';

export const examples = [
    {
        title: 'react-native-pickers',
        render: function (): any {
            return <PickersExample />;
        },
    },
];
