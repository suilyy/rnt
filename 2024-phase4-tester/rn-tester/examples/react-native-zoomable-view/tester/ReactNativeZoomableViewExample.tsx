...
export const displayName = 'react-native-zoomable-view';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-zoomable-view';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-zoomable-view.md';
export const description = 'react-native-zoomable-view';
