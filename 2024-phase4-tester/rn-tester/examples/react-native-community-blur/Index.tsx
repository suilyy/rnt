...
export const displayName = 'CommunitrBlurDemo';
export const framework = 'React';
export const category = 'basic';
export const title = 'CommunitrBlurDemo';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-community-blur.md';
export const description = 'CommunitrBlurDemo';

export const examples = [
    {
        title: 'CommunitrBlurDemo',
        render: function (): any {
            return <CommunitrBlurDemo />;
        },
    },
];
