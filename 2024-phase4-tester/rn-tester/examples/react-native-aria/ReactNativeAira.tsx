...
export const displayName = 'ReactNativeAira';
export const framework = 'React';
export const category = 'basic';
export const title = 'ReactNativeAira';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-aria.md';
export const description = 'ReactNativeAira';

export const examples = [
    {
        title: 'ReactNativeAira',
        render: function (): any {
            return <T_ReactNativeAira />;
        },
    },
];
