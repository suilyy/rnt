...
export const displayName = 'react-native-iconfont-cli';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-iconfont-cli';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-iconfont-cli.md';
export const description = 'react-native-iconfont-cli';

export const examples = [
    {
        title: 'react-native-iconfont-cli',
        render: function (): any {
            return <IconExample />;
        },
    },
