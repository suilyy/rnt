...
export const displayName = 'T_ReactNativeTranslucentModal';
export const framework = 'React';
export const category = 'basic';
export const title = 'T_ReactNativeTranslucentModal';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-translucent-modal.md';
export const description = 'T_ReactNativeTranslucentModal';

export const examples = [
    {
        title: 'T_ReactNativeTranslucentModal',
        render: function (): any {
            return <T_ReactNativeTranslucentModal />;
        },
    },
];
