...
export const displayName = 'DotEnvTest';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-dotenv';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-dotenv.md';
export const description = 'DotEnvTest';
