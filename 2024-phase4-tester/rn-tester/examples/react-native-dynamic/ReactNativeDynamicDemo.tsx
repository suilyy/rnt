...
export const displayName = 'react-native-dynamic';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-dynamic';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-dynamic.md';
export const description = 'react-native-dynamic';
