...
export const title = 'react-router-dom';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-router-dom.md';
export const description = 'react-router-dom';

export const examples = [
    {
        title: 'react-router-dom',
        render: function (): any {
            return <ReactRouterDomTest />;
        },
    },
];
