...
export const displayName = 'react-native-community-picker';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-community-picker';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-picker-picker.md';
export const description = 'react-native-community/picker';

export const examples = [
    {
        title: 'react-native-community/picker',
        render: function (): any {
