...
export const displayName = 'react-native-print';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-print';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-print.md';
export const description = 'react-native-print';
