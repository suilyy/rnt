...
export const displayName = 'react-native-community-push-notification-ios';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-community-push-notification-ios';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-community-push-notification-ios.md';
export const description = 'react-native-community/react-native-community-push-notification-ios';

export const examples = [
    {
        title: 'react-native-community/react-native-community-push-notification-ios',
        render: function (): any {
