...
// 使用 export 导出
export const displayName = "DropDownExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-autocomplete-dropdown";
export const documentationURL = "https://github.com/onmotion/react-native-autocomplete-dropdown";
export const description = "Simple React Native autocomplete dropdown component.";

export const examples = [
  {
    title: "Autocomplete dropdown with default styling",
    render: function (): any {
      return <DropDownDemo />;
    },
  },
