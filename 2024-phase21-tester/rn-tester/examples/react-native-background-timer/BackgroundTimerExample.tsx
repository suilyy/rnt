...
// 使用 export 导出
export const displayName = "BackgroundTimerExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-background-timer";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-background-timer";
export const description = "Simple React Native background timer component.";

export const examples = [
  {
    title: "Background timer with default styling",
    render: function (): any {
      return <BackgroundTimerExample />;
    },
  },
];