...
// 使用 export 导出
export const displayName = "SpinKitExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-spinkit";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-spinkit";
export const description = "Simple React Native spinkit component.";

export const examples = [
  {
    title: "Spinkit with default styling",
    render: function (): any {
      return <SpinKitDemo />;
    },
  },
