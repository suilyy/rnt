...
// 使用 export 导出
export const displayName = "TrackPlayerExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-track-player";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-track-player";
export const description = "Simple React Native track player component.";

export const examples = [
  {
    title: "Track player with default styling",
    render: function (): any {
      return <TrackPlayerTest />;
    },
  },
];
