...
// 使用 export 导出
export const displayName = "GridExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-easy-grid";
export const documentationURL = "https://github.com/GeekyAnts/react-native-easy-grid";
export const description = "Simple React Native easy grid component.";

export const examples = [
  {
    title: "Easy grid with default styling",
    render: function (): any {
      return <GridExample />;
    },
  },
