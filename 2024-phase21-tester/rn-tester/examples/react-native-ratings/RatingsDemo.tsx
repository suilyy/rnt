...
// 使用 export 导出
export const displayName = "RatingsExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-ratings";
export const documentationURL = "https://github.com/Monte9/react-native-ratings";
export const description = "Simple React Native ratings component.";

export const examples = [
  {
    title: "Ratings with default styling",
    render: function (): any {
      return <RatingsDemo />;
    },
  },
