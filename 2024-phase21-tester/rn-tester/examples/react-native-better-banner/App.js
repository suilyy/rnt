...
// 使用 export 导出
export const displayName = "BetterBannerExample";
export const framework = "React";
export const category = "UI";
export const title = "better-banner";
export const documentationURL = "https://github.com/react-native-oh-library/better-banner";
export const description = "Simple React Native better banner component.";

export const examples = [
  {
    title: "Better banner with default styling",
    render: function (): any {
      return <BetterBannerTest />;
    },
  },
];
