...
// 使用 export 导出
export const displayName = "SignatureCaputureExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-signature-capture";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-signature-capture";
export const description = "Simple React Native signature capture component.";

export const examples = [
  {
    title: "Signature capture with default styling",
    render: function (): any {
      return <SignatureCaputureAllDemo />;
    },
  },
];
