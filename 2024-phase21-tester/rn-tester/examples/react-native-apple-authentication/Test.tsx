...
// 使用 export 导出
export const displayName = "AppleAuthenticationExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-apple-authentication";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-apple-authentication";
export const description = "Simple React Native apple authentication component.";

export const examples = [
  {
    title: "Apple authenticatio with default styling",
    render: function (): any {
      return <AppleAuthenticationTest />;
    },
  },
];