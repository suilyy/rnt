...
// 使用 export 导出
export const displayName = "QrDecodeImageCameraExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-qr-decode-image-camera";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-qr-decode-image-camera";
export const description = "Simple React Native button component.";

export const examples = [
  {
    title: "react-native-qr-decode-image-camera",
    render: function (): any {
      return <QrDecodeImageCamera />;
    },
  },
];
