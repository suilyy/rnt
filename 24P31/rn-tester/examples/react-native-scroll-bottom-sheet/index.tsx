...
export const displayName = "ReactNativeScrollBottomSheet";
export const framework = "React";
export const category = "UI";
export const title = "react-native-scroll-bottom-sheet";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-scroll-bottom-sheet";
export const description = "React Native Scroll Bottom Sheet";

export const examples = [
  {
    title: "react-native-scroll-bottom-sheet",
    render: function (): any {
      return <App />;
    },
  },
