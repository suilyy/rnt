...
export const displayName = 'AudioRecordPlayerExample';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-audio-recorder-player';
export const documentationURL = 'https://github.com/hyochan/react-native-audio-recorder-player';
export const description = 'React Native Audio recorder player';
