...
export const displayName = "ReactNativeNetworkInfo";
export const framework = "React";
export const category = "UI";
export const title = "react-native-network-info";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-network-info";
export const description = "React Native Network Info";

export const examples = [
  {
    title: "react-native-network-info",
    render: function (): any {
      return <NetworkInfoTest />;
    },
  },
];