...
export const displayName = "Ting";
export const framework = "React";
export const category = "UI";
export const title = "ting";
export const documentationURL = "https://github.com/react-native-oh-library/ting";
export const description = "Ting";
