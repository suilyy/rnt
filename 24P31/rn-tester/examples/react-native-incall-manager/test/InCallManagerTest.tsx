...
export const displayName = "ReactNativeIncallManager";
export const framework = "React";
export const category = "UI";
export const title = "react-native-incall-manager";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-incall-manager";
export const description = "React Native Incall Manager";

export const examples = [
    {
        title: "react-native-incall-manager",
        render: function (): any {
            return <InCallManagerTest />;
        },
    },
];
