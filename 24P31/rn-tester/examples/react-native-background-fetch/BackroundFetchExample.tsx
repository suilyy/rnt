...
export const displayName = "ReactNativeBackgroundFetch";
export const framework = "React";
export const category = "UI";
export const title = "react-native-background-fetch";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-background-fetch";
export const description = "React Native Background Fetch";
