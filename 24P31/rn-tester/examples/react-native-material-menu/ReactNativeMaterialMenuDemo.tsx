...
export const displayName = 'MaterialMenuExample';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-material-menu';
export const documentationURL = 'https://github.com/mxck/react-native-material-menu';
export const description = 'React Native MaterialMenu';

export const examples = [
    {
        title: 'react-native-material-menu',
        render: function (): any {
            return <MaterialMenuTest />;
        },
    },
];
