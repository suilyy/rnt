...
export const displayName = "ShadowsDemo";
export const framework = "React";
export const category = "UI";
export const title = "react-native-neomorph-shadows";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-neomorph-shadows";
export const description = "React Native Neomorph Shadows";

export const examples = [
  {
    title: "react-native-neomorph-shadows",
    render: function (): any {
      return <ShadowsDemo />;
    },
  },
