...
export const displayName = 'MaskTextDemo';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-mask-text';
export const documentationURL = 'https://reactnative.dev/docs/button';
export const description = 'React Native MaskText.';

export const examples = [
  {
    title: 'React Native MaskText',
    render: function (): any {
      return <MaskTextDemo />;
    },
  },
