...
export const displayName = "ReactNativeReanimatedBottomSheet";
export const framework = "React";
export const category = "UI";
export const title = "react-native-reanimated-bottom-sheet";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-bottom-sheet";
export const description = "React Native Reanimated Bottom Sheet";

export const examples = [
  {
    title: "react-native-reanimated-bottom-sheet",
    render: function (): any {
      return <BottomSheetDemo filter={{}} />;
    },
  },
];
