...
export const displayName = "ReactNativeParsedText";
export const framework = "React";
export const category = "UI";
export const title = "react-native-parsed-text";
export const documentationURL = "https://github.com/taskrabbit/react-native-parsed-text";
export const description = "React Native Parsed Text";

export const examples = [
  {
    title: "react-native-parsed-text",
    render: function (): any {
      return <TestNativeParsedTextDemo filter={{}} />;
    },
  },
];
