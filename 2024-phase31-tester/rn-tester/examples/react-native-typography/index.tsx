...
export const displayName = "ReactNativeTypography";
export const framework = "React";
export const category = "UI";
export const title = "react-native-typography";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-typography";
export const description = "React Native Typography";
