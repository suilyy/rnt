...
export const displayName = "ReactNativeThemeSwitchAnimation";
export const framework = "React";
export const category = "UI";
export const title = "react-native-theme-switch-animation";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-theme-switch-animation";
export const description = "React Native Theme Switch Animation";

export const examples = [
  {
    title: "react-native-theme-switch-animation",
    render: function (): any {
      return <ReactNativeThemeSwitchAnimation />;
    },
  },
];