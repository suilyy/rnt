...
export const displayName = 'ReactNativeKeyboardAccessory';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-keyboard-accessory';
export const documentationURL = 'https://github.com/react-native-oh-library/react-native-keyboard-accessory';
export const description = 'React Native Keyboard Accessory';

export const examples = [
  {
    title: 'react-native-keyboard-accessory',
    render: function (): any {
      return <BusKeyBoardIndexDemo />;
    },
  },
];