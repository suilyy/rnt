...
export const displayName = "ReactNativeMaterialRipple";
export const framework = "React";
export const category = "UI";
export const title = "react-native-material-ripple";
export const documentationURL = "https://github.com/n4kz/react-native-material-ripple";
export const description = "React Native Material Ripple";

export const examples = [
  {
    title: "react-native-material-ripple",
    render: function (): any {
      return <MateriaRippleExample />;
    },
  },
];
