...
export function SecureRandomDemo(number: number): JSX.Element {
...
export const displayName = 'Securerandom';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-securerandom';
export const documentationURL = 'https://github.com/mxck/react-native-material-menu';
export const description = 'React Native securerandom';

export const examples = [
    {
        title: 'react-native-material-menu',
        render: function (): any {
            return <SecureRandomDemo number={30} />;
        },
    },
];