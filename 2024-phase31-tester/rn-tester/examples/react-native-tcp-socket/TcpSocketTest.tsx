...
export const displayName = "TcpSocketTest";
export const framework = "React";
export const category = "UI";
export const title = "react-native-tcp-socket";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-tcp-socket";
export const description = "React Native Tcp Socket";
