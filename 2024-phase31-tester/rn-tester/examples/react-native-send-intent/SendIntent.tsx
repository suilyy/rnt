...
export const displayName = 'ReactNativeSendIntent';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-send-intent';
export const documentationURL = 'https://github.com/react-native-oh-library/react-native-send-intent';
export const description = 'React Native Send Intent';

export const examples = [
  {
    title: 'react-native-send-intent',
    render: function (): any {
      return <SendIntent />;
    },
  },
