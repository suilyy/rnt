...
export const displayName = 'ReactNativeEmailLink';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-email-link';
export const documentationURL = 'https://github.com/react-native-oh-library/react-native-email-link';
export const description = 'react-native-email-link';

export const examples = [
  {
    title: 'react-native-email-link',
    render: function (): any {
      return <EmailLinkExample />;
    },
  },
];