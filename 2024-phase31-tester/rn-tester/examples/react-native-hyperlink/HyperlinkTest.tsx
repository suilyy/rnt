...
export const displayName = "HyperlinkTest";
export const framework = "React";
export const category = "UI";
export const title = "react-native-hyperlink";
export const documentationURL = "https://github.com/n4kz/react-native-indicators";
export const description = "React Native Hyperlink";

export const examples = [
    {
        title: "react-native-hyperlink",
        render: function (): any {
            return <HyperlinkExamples />;
        },
    },
];
