...
export const displayName = "SwitchDemo";
export const framework = "React";
export const category = "UI";
export const title = "react-native-switch";
export const documentationURL = "https://github.com/shahen94/react-native-switch";
export const description = "React Native Switch";
