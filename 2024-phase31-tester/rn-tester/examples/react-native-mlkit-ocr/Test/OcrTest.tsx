                                    ...
                                    return (
                                        <View style={{ flex: 1 }}>
                                            <Button
                                                label="识别本地照片"
                                                onPress={() => {
                                                    MlkitOcr.detectFromFile('assets/rn-tester/examples/assets/ocr_test.jpg').then(res => {
                                                        setTimeout(() => {
                                                            setResult(res)
                                                            setState(!!res)
...
export const displayName = "ReactNativeMlkitOcr";
export const framework = "React";
export const category = "UI";
export const title = "react-native-mlkit-ocr";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-mlkit-ocr";
export const description = "React Native Mlkit Ocr";

export const examples = [
  {
    title: "react-native-mlkit-ocr",
    render: function (): any {
      return <OcrTest />;
    },
  },
