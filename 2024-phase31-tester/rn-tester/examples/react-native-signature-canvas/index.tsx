...
export const displayName = 'react-native-signature-canvas';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-signature-canvas';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-signature-canvas.md';
export const description = 'react-native-signature-canvas';

export const examples = [
    {
        title: 'react-native-signature-canvas',
        render: function (): any {
            return <SignatureCanvasExample />;
        },
    },
];
