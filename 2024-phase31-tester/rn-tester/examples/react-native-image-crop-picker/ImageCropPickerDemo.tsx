...
export const displayName = "ReactNativeImageCropPicker";
export const framework = "React";
export const category = "UI";
export const title = "react-native-image-crop-picker";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-image-crop-picker";
export const description = "React Native Image Crop Picker";

export const examples = [
    {
        title: "react-native-image-crop-picker",
        render: function (): any {
            return <ImageCropPickerDemo />;
        },
    },
];