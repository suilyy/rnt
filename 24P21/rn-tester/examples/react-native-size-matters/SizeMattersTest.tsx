...
// 使用 export 导出
export const displayName = "SizeMattersExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-size-matters";
export const documentationURL = "https://github.com/nirsky/react-native-size-matters";
export const description = "Simple React Native size matters component.";

export const examples = [
  {
    title: "Size matters with default styling",
    render: function (): any {
      return <SizeMattersTest />;
    },
  },
];
