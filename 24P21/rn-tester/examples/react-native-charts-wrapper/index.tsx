...
export const displayName = 'ChartsWrapperDemo';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-charts-wrapper';
export const documentationURL = 'https://reactnative.dev/docs/button';
export const description = 'react-native-charts-wrapper';

export const examples = [
  {
    title: 'react-native-button',
    render: function (): any {
      return <ChartsWrapperDemo />;
    },
  },
];
