...
// 使用 export 导出
export const displayName = "CreateThumbnailExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-create-thumbnail";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-create-thumbnail";
export const description = "Simple React Native create thumbnail component.";

export const examples = [
  {
    title: "Create thumbnail with default styling",
    render: function (): any {
      return <CreateThumbnailDemo />;
    },
  },
];
