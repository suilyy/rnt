...
// 使用 export 导出
export const displayName = "MaterialButtonsExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-material-buttons";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-material-buttons";
export const description = "Simple React Native material buttons component.";

export const examples = [
  {
    title: "Material buttons with default styling",
    render: function (): any {
      return <MaterialButtonsExample />;
    },
  },
];