...
// 使用 export 导出
export const displayName = "OrientationLockerExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-orientation-locker";
export const documentationURL = "https://github.com/wonday/react-native-orientation-locker";
export const description = "Simple React Native orientation locker component.";

export const examples = [
  {
    title: "Orientation locker with default styling",
    render: function (): any {
      return <OrientationLockerExample />;
    },
  },
];