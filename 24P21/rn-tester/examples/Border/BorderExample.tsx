...
import { DynamicColorIOS, Image, Platform, PlatformColor, StyleSheet, View } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  border16: {
    borderWidth: 10,
    borderColor:
      Platform.OS === 'ios' ? DynamicColorIOS({ light: 'magenta', dark: 'cyan' }) : 'black',
  },
...
export const examples = [
  {
    ...
    render: function () {
      return (
        <View testID="border-test-equal-width-same-color" style={[styles.box, styles.border1]} />
      );
    },
  },
  {
  ...
  },
  {
    ...
    render: function () {
      return <View testID="border-test-equal-width-borders" style={[styles.box, styles.border2]} />;
    },
  },
  {
    ...
    render: function () {
      return <View testID="border-test-same-color-borders" style={[styles.box, styles.border3]} />;
    },
  },
  {
    ...
    render: function () {
      return <View testID="border-test-custom-borders" style={[styles.box, styles.border4]} />;
    },
  },
  {
    title: 'Custom Borders',
    ...
    render: function () {
      return (
        <View testID="border-test-custom-borders-ios-1" style={[styles.box, styles.border5]} />
      );
    },
  },
  {
    ...
    render: function () {
      return (
        <View testID="border-test-custom-borders-ios-2" style={[styles.box, styles.border6]} />
      );
    },
  },
  {
    ...
    render: function () {
      return (
        <View testID="border-test-custom-borders-ios-clipping" style={[styles.box, styles.border7]}>
  ...
  },
  {
    ...
    render: function () {
      return <View testID="border-test-corner-radii" style={[styles.box, styles.border9]} />;
    },
  },
  {
  ...
  },
  {
    ...
    render: function () {
      return (
        <View testID="border-test-corner-radii-elevation" style={[styles.box, styles.border10]} />
      );
    },
  },
  {
  ...
  },
  {
    ...
    render: function () {
      return <View testID="border-test-css-trick-triangle" style={[styles.border11]} />;
    },
  },
  {
    ...
    render: function () {
      return (
        <View testID="border-test-curved-border-lrbt-width" style={[styles.box, styles.border12]} />
      );
    },
  },
  {
    ...
    render: function () {
      return (
        <View testID="border-test-curved-border-lrbt-color" style={[styles.box, styles.border13]} />
      );
    },
  },
  {
  ...
  },
  {
    ...
    render: function () {
      return <View testID="border-test-system-color" style={[styles.box, styles.border15]} />;
    },
  },
  {
    title: 'Dynamic color',
    ...
    platform: 'ios',
    render: function () {
      return <View testID="border-test-dynamic-color-ios" style={[styles.box, styles.border16]} />;
    },
  },
  {
    title: 'Child without clipping',
    name: 'child-no-clipping',
    description: '"overflow: visible" will cause child content to show above borders',
    render: function () {
      return (
        <View
          testID="border-test-child-no-clipping"
          style={[styles.box, styles.borderWithoutClipping]}>
          <Image source={require('../../assets/hotdog.jpg')} style={styles.hotdog} />
        </View>
      );
    },
  },
  {
    ...
    name: 'child-clipping',
    description: '"overflow: hidden" will cause child content to be clipped to borders',
    render: function () {
      return (
        <View testID="border-test-child-clipping" style={[styles.box, styles.borderWithClipping]}>
          <Image source={require('../../assets/hotdog.jpg')} style={styles.hotdog} />
        </View>
      );
    },
  },
  {
    ...
    description: '"overflow: hidden" will cause child content to be clipped to rounded corners',
    render: function () {
      return (
        <View
    ...
    render: function () {
      return (
        <View
          ...
          <View style={[styles.smallBox, styles.borderWithChildren2, { overflow: 'hidden' }]}>
            <View style={styles.childOfBorder} />
          </View>
