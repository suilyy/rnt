...
// 使用 export 导出
export const displayName = "RNThemeProviderExample";
export const framework = "React";
export const category = "UI";
export const title = "react-theme-provider";
export const documentationURL = "https://github.com/callstack/react-theme-provider";
export const description = "Simple React Native theme provider component.";

export const examples = [
  {
    title: "Theme provider with default styling",
    render: function (): any {
