...
// 使用 export 导出
export const displayName = "RootToastExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-root-toast";
export const documentationURL = "https://github.com/magicismight/react-native-root-toast";
export const description = "Simple React Native root toast component.";

export const examples = [
  {
    title: "Root toast with default styling",
    render: function (): any {
      return <ReactNativeRootToastExample />;
    },
  },
];
