...
// 使用 export 导出
export const displayName = "FeatherExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-feather";
export const documentationURL = "https://github.com/yigithanyucedag/react-native-feather";
export const description = "Simple React Native feather component.";

export const examples = [
  {
    title: "feather with default styling",
    render: function (): any {
      return <FeatherExample />;
    },
  },
];