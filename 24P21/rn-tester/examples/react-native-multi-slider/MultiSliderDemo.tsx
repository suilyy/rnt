...
// 使用 export 导出
export const displayName = "MultiSliderExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-multi-slider";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-multi-slider";
export const description = "Simple React Native multi slider component.";

export const examples = [
  {
    title: " Multi slider with default styling",
    render: function (): any {
      return <MultiSliderDemo />;
    },
  },
];
