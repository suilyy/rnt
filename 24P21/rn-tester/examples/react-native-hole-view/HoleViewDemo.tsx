...
export const displayName = 'HoleViewExample';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-hole-view';
export const documentationURL = 'https://github.com/ibitcy/react-native-hole-view';
export const description = 'React Native HoleView';

export const examples = [
  {
    title: 'react-native-hole-view',
    render: function () {
      return <HoleViewDemo />;
    },
  },
