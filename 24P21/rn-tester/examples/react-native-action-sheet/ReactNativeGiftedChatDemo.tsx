...
const styles = StyleSheet.create({
  ...
  export const displayName = 'ReactNativeGiftedChat';
  export const framework = 'React';
  export const category = 'UI';
  export const title = 'react-native-action-sheet';
  export const documentationURL = 'https://reactnative.dev/docs/button';
  export const description = 'React Native Action Sheet';

  export const examples = [
    {
      title: 'react-native-action-sheet',
      render: function (): any {
        return <ReactNativeGiftedChat />;
      },
    },
  ];