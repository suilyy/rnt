...
export default {
  displayName: "ClipPathViewDemo",
  framework: "React",
  category: "UI",
  title: "ClipPathViewDemo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-clippath-capi.md",
  description: "提供了一种简单的方式来实现剪裁路径（Clipping Path）效果",
  examples: [
    {
      title: "react-native-clippath",
      render: function (): any {
        return <ClipPathViewDemo />;
      },
    },
  ],
};
