...
export default {
  displayName: "SimpleToastDemo",
  framework: "React",
  category: "UI",
  title: "SimpleToastDemo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-simple-toast.md",
  description: "弹框组件",
  examples: [
    {
      title: "simple-toast",
