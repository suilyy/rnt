...
export default {
  displayName: "GestureHandlersDemo",
  framework: "React",
  category: "UI",
  title: "GestureHandlersDemo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-gesture-handler.md",
  description: "手势库组件",
  examples: [
    {
      title: "GestureHandlers",
      render: function (): any {
        return <App />;
      },
    },
