...
export default {
  displayName: "PagerViewDemo",
  framework: "React",
  category: "UI",
  title: "PagerViewDemo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-pager-view.md",
  description: "实现水平滑动的页面切换效果，适合用于实现引导页、图片轮播、多页表单等场景",
  examples: [
    {
      title: "PagerView",
      render: function (): any {
