...
export default {
  displayName: "DeviceInfoDemo",
  framework: "React",
  category: "Tools",
  title: "DeviceInfoDemo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-device-info.md",
