...
export default {
  displayName: "color-matrix-image-filters-demo",
  framework: "React",
  category: "UI",
  title: "color-matrix-image-filters-demo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-color-matrix-image-filters.md",
  description: "实现各种图像滤镜效果",
  examples: [
    {
      title: "color-matrix-image-filters",
      render: function (): any {
        return <ColorImageFilter />;
      },
    },
  ],
};
