...
export const displayName = "URLPolyfillExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-url-polyfill";
export const documentationURL = "https://github.com/charpeni/react-native-url-polyfill";
export const description = "Simple React Native url polyfill.";

export const examples = [
  {
    title: "URLPoly fill Example",
    render: function (): any {
      return <URLPolyfillDemo />;
    },
  },
];