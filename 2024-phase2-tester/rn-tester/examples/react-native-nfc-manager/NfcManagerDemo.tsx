...
// 使用 export 导出
export const displayName = "NfcManagerExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-nfc-manager";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-nfc-manager";
export const description = "Simple React Native nfc manager component.";

export const examples = [
  {
    title: "Nfc manager with default styling",
    render: function (): any {
      return <NfcManagerDemo />;
    },
  },
];