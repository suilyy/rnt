...
// 使用 export 导出
export const displayName = "SystemSettingExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-system-setting";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-system-setting";
export const description = "Simple React Native system setting component.";

export const examples = [
  {
    title: "System-setting with default styling",
    render: function (): any {
      return <SystemSettingDemo />;
    },
  },
];
