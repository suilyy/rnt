...
// 使用 export 导出
export const displayName = "HttpBridgeDemo";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-http-bridge";
export const documentationURL = "https://github.com/alwx/react-native-http-bridge";
export const description = "Simple React Native http bridge.";

export const examples = [
  {
    title: "Http Bridge",
    render: function (): any {
      return <HttpBridgeDemo />;
    },
  },
];