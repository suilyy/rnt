...
export const displayName = 'FlashMessage';
export const framework = 'React';
export const category = 'UI';
export const title = 'FlashMessage';
export const documentationURL = 'https://github.com/lucasferreira/react-native-flash-message';
export const description = 'React Native Flash Message';

export const examples = [
  {
    title: 'React Native Flash Message',
    render: function (): any {
      return <FlashMessageTest />;
    },
  },
];