...
// 使用 export 导出
export const displayName = "MetariDesignColorExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-material-design-styles";
export const documentationURL = "https://github.com/binggg/react-native-material-design-styles";
export const description = "Simple React Native material design styles component.";

export const examples = [
  {
    title: "Material design styles with default styling",
    render: function (): any {
      return <MetariDesignColorTest />;
    },
  },
];