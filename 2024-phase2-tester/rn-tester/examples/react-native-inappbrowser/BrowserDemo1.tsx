...
// 使用 export 导出
export const displayName = "BrowserExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-inappbrowser";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-inappbrowser";
export const description = "Simple React Native inappbrowser component.";

export const examples = [
  {
    title: "Inappbrowser with default styling",
    render: function (): any {
      return <BrowserDemo />;
    },
  },
