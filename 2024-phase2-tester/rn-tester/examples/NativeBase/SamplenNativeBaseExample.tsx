...
export const displayName = 'NativeBaseExample';
export const framework = 'React';
export const category = 'UI';
export const title = 'NativeBase';
export const documentationURL = 'https://docs.nativebase.io/getting-started';
export const description = 'NativeBase';

export const examples = [
  {
    title: 'NativeBase',
    render: function (): any {
      return <SampleNativeBaseExample />;
    },
  },
];
