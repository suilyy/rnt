...
// 使用 export 导出
export const displayName = "GetRandomValuesExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-get-random-values";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-get-random-values";
export const description = "Simple React Native get random values component.";

export const examples = [
  {
    title: "react-native-get-random-values with default styling",
    render: function (): any {
      return <GetRandomValuesExample />;
    },
  },
];
