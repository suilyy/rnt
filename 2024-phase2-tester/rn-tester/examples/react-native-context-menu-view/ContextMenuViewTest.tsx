...
export const displayName = 'ContextMenuViewExample';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-context-menu-view';
export const documentationURL = 'https://github.com/mpiannucci/react-native-context-menu-view';
export const description = 'React Native Context Menu View';

export const examples = [
  {
    title: 'react-native-context-menu-view',
    render: function () {
      return <ContextMenuViewTest />;
    },
  },
];
