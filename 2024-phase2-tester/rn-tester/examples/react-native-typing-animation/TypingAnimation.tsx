...
// 使用 export 导出
export const displayName = "TypingAnimationExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-typing-animation";
export const documentationURL = "https://github.com/watadarkstar/react-native-typing-animation";
export const description = "Simple React Native typing animation component.";

export const examples = [
  {
    title: "Typing animation with default styling",
    render: function (): any {
