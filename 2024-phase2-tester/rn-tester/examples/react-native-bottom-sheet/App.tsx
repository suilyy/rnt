...
// 使用 export 导出
export const displayName = "BottomSheetExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-bottom-sheet";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-bottom-sheet";
export const description = "Simple React Native bottom sheet component.";

export const examples = [
  {
    title: "Bottom sheet with default styling",
    render: function (): any {
      return <App />;
    },
  },
