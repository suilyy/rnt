 ...
 class ToastTest extends Component {
    ...
    onClick(props) {
        ...
        this.setState({
            ...
            fadeInDuration: props.fadeInDuration || 500,
            fadeOutDuration: props.fadeOutDuration || 500,
            opacity: props.opacity ?? 1,
            textStyle: {
                color: props.textStyle || '#ffffff'
            },
            backgroundColor: props.backgroundColor || 'red'
        }, () => {

            if (props.withStyle) {
                this.toastWithStyle.show(props.text, props.duration);
            } else {
                this.toast.show(props.text, props.duration);
            }
        })
...
export const displayName = 'EasyToastExample';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-easy-toast';
export const documentationURL = 'https://reactnative.dev/docs/button';
export const description = 'React Native easy toast';
