...
// 使用 export 导出
export const displayName = "LightBoxExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-lightbox";
export const documentationURL = "https://github.com/cbbfcd/react-native-lightbox";
export const description = "Simple React Native lightbox component.";

export const examples = [
  {
    title: "lightbox with default styling",
    render: function (): any {
      return <ReactNativeLightBoxExample />;
    },
  },
];