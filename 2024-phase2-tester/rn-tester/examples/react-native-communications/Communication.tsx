...
// 使用 export 导出
export const displayName = "CommunicationsExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-communications";
export const documentationURL = "https://github.com/davebeehively/react-native-communications";
export const description = "Simple React Native Communications component.";

export const examples = [
  {
    title: "Communications with default styling",
    render: function (): any {
