...
// 使用 export 导出
export const displayName = "SharedElmentExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-shared-element";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-shared-element";
export const description = "Simple React Native shared element component.";

export const examples = [
  {
    title: "react-native-shared-element",
    render: function (): any {
      return <SharedElmentTest />;
    },
  },
];