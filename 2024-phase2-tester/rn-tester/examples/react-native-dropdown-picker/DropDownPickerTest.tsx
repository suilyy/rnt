...
export const displayName = 'ReactNativeDropdownPicker';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-dropdown-picker';
export const documentationURL = 'https://github.com/hossein-zare/react-native-dropdown-picker';
export const description = 'React Native Dropdown Picker';

export const examples = [
    {
      title: "react-native-dropdown-picker",
      render: function (): any {
        return <DropDownPickerTest />;
      },
    },
  ];