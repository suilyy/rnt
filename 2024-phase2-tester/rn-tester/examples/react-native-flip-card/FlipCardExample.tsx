...
// 使用 export 导出
export const displayName = "FlipCardExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-flip-card";
export const documentationURL = "https://github.com/moschan/react-native-flip-card";
export const description = "Simple React Native flip card component.";

export const examples = [
  {
    title: "Flip card with default styling",
    render: function (): any {
