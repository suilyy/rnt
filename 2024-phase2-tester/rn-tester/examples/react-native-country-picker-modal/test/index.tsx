...
export const displayName = 'RNCountryPicker';
export const framework = 'React';
export const category = 'UI';
export const title = 'Country Picker';
export const documentationURL = "https://github.com/react-native-oh-library/react-native-country-picker-modal";
export const description = 'React Native Country Picker';

export const examples = [
  {
    title: 'React Native Country Picker',
    render: function (){
      return <CountryPickerTest />;
    },
  },
];
