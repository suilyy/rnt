...
// 使用 export 导出
export const displayName = "HtmlViewExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-htmlview";
export const documentationURL = "https://github.com/jsdf/react-native-htmlview";
export const description = "Simple React Native htmlview component.";

export const examples = [
  {
    title: "Htmlview with default styling",
    render: function (): any {
