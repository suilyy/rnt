...
function DocumentPickerDemo(): JSX.Element {
...
export const displayName = 'DocumentPickerExample';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-document-picker';
export const documentationURL = 'https://github.com/rnmods/react-native-document-picker';
export const description = 'React Native Document Picker';

export const examples = [
  {
    title: 'react-native-document-picker',
    render: function () {
