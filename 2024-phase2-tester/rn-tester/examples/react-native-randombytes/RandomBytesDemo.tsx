...
// 使用 export 导出
export const displayName = "RandombytesExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-randombytes";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-randombytes";
export const description = "Simple React Native randombytes component.";

export const examples = [
  {
    title: "Randombytes with default styling",
    render: function (): any {
      return <RandomBytesDemo />;
    },
  },
];
