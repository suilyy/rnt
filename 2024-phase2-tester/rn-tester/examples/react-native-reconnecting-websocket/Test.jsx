...
export const title = 'react-native-reconnecting-websocket';
export const documentationURL = 'https://github.com/React-Sextant/react-native-reconnecting-websocket';
export const description = 'websocket module';

export const examples = [
    {
        title: 'react-native-reconnecting-websocket',
        render: function () {
            return <ReconnectingWebsocketTest />;
        },
    },
];
