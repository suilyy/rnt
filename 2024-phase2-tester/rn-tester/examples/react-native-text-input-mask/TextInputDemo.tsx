...
// 使用 export 导出
export const displayName = "TextInputExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-text-input-mask";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-text-input-mask";
export const description = "Simple React Native text input mask component.";

export const examples = [
  {
    title: "Text input mask  with default styling",
    render: function (): any {
