...
// 使用 export 导出
export const displayName = "CryptoExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-crypto";
export const documentationURL = "https://github.com/tradle/react-native-crypto";
export const description = "Simple React Native crypto component.";

export const examples = [
  {
    title: "Crypto with default styling",
    render: function (): any {
      return <TestCrypto />;
    },
  },
