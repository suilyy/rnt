...
function SampleElementExample(): JSX.Element {
  return (
...
export const displayName = 'react-native-elements (test)';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-elements (test)';
