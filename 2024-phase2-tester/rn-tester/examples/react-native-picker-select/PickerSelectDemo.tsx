...
// 使用 export 导出
export const displayName = "PickerSelectExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-picker-select";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-picker-select";
export const description = "Simple React Native picker select component.";

export const examples = [
  {
    title: "Picker select with default styling",
    render: function (): any {
      return <PickerSelectDemo />;
    },
  },
];