...
// 使用 export 导出
export const displayName = "SwitchSelectorExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-switch-selector";
export const documentationURL = "https://github.com/App2Sales/react-native-switch-selector";
export const description = "Simple React Native switch selector component.";

export const examples = [
  {
    title: "Switch selector with default styling",
    render: function (): any {
      return <SwitchSelectorDemo />;
    },
  },
];