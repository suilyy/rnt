...
// 使用 export 导出
export const displayName = "ModalExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-modal";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-modal";
export const description = "Simple React Native modal component.";

export const examples = [
  {
    title: "Modal with default styling",
    render: function (): any {
      return <ModalDemo />;
    },
  },
