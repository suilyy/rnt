...
// 使用 export 导出
export const displayName = "JPushExample";
export const framework = "React";
export const category = "Basic";
export const title = "jpush-react-native";
export const documentationURL = "https://github.com/react-native-oh-library/jpush-react-native";
export const description = "Simple React Native jpush component.";

export const examples = [
  {
    title: "JPush with default styling",
    render: function (): any {
      return <JPushExample />;
    },
  },
