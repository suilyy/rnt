...
// 使用 export 导出
export const displayName = "PrintExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-print";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-print";
export const description = "Simple React Native print component.";
