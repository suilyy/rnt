...
export const displayName = 'SortableList';
export const framework = 'React';
export const category = 'UI';
export const title = 'SortableList';
export const documentationURL = "https://github.com/react-native-oh-library/react-native-sortable-list";
