...
// 使用 export 导出
export const displayName = "LocalizationExample";
export const framework = "React";
export const category = "Basic";
export const title = "ReactNativeLocalization";
export const documentationURL = "https://github.com/react-native-oh-library/ReactNativeLocalization";
export const description = "Simple React Native Localization component.";

export const examples = [
  {
    title: "Localization with default styling",
    render: function (): any {
      return <LocalizationTestCase />;
    },
  },
];
