...
// 使用 export 导出
export const displayName = "CollapsibleExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-collapsible";
export const documentationURL = "https://github.com/oblador/react-native-collapsible";
export const description = "Simple React Native collapsible component.";

export const examples = [
  {
    title: "collapsible with default styling",
    render: function (): any {
