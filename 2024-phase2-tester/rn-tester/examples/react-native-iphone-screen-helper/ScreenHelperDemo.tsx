...
// 使用 export 导出
export const displayName = "ScreenHelperExample";
export const framework = "React";
export const category = "Basic";
export const title = "react-native-iphone-screen-helper";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-iphone-screen-helper";
export const description = "Simple React Native iphone screen helper component.";

export const examples = [
  {
    title: "react-native-iphone-screen-helper with default styling",
    render: function (): any {
      return <ScreenHelperDemo />;
    },
  },
];