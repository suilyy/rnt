...
export const displayName = 'react-native-idfa-aaid'; 
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-idfa-aaid';
export const documentationURL = 'https://github.com/react-native-oh-library/RNOHDCS/tree/main/react-native-idfa-aaid';
export const description = 'React Native idfa aaid';
