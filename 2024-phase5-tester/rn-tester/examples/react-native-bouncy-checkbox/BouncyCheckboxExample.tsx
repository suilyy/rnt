...
export const displayName = 'ReactNativeBouncyCheckbox';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-bouncy-checkbox';
export const documentationURL = 'https://reactnative.dev/docs/button';
export const description = 'React Native Bouncy Checkbox';
