...
export const displayName = 'ReactNativeSwipeGestures';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-swipe-gestures';
export const documentationURL = 'https://reactnative.dev/docs/button';
export const description = 'React Native Swipe Gestures';

export const examples = [
  {
    title: 'react-native-swipe-gestures',
    render: function (): any {
      return <SwipeGesturesTest />;
    },
  },
];
