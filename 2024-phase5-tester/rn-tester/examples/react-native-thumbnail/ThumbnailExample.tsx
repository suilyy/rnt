...
import RNThumbnail from '@react-native-oh-tpl/react-native-thumbnail';
import { launchCamera, launchImageLibrary } from '@react-native-oh-tpl/react-native-image-picker';
...
export const displayName = 'ReactNativeThumbnail';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-thumbnail';
export const documentationURL = 'https://reactnative.dev/docs/button';
export const description = 'React Native Thumbnail';
