...
import Alipay from "@react-native-oh-tpl/react-native-alipay";
...
export const displayName = 'ReactNativeAlipay';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-alipay';
export const documentationURL = 'https://reactnative.dev/docs/button';
export const description = 'React Native Alipay';
