              ...
              arrange={({ setState }) => {
                return (
                  ...
                  <VideoPlayer
                    ...
                    source={{uri: isurl ? 'https://vjs.zencdn.net' : 'https://vjs.zencdn.net/v/oceans.mp4'}}    
                    paused = {true}
                  />
                  <TouchableOpacity onPress={()=>changeUrl()}><Text>切换为不可调用视频地址</Text></TouchableOpacity>
                  </>
                )
              }}
            >
...
export const displayName = 'ReactNativeVideoControls';
