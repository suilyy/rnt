...
import SmartRefreshLayouRenderHeader from './SmartRefreshLayouRenderHeader';
...
const demos: IDemoItem[] = [
  ...
  { Component: SmartRefreshLayouRenderHeader, name: 'RenderHeader', key: 'SmartRefreshLayouRenderHeader' },
];
...
export default {
  displayName: "SmartRefreshLayoutDemo",
  framework: "React",
  category: "UI",
  title: "SmartRefreshLayoutDemo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-SmartRefreshLayout.md",
  description: "下拉刷新",
  examples: [
    {
