...
export default {
  displayName: "FlexiRadioButtonDemo",
  framework: "React",
  category: "UI",
  title: "FlexiRadioButtonDemo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-flexi-radio-button.md",
  description: "灵活且高度可定制的单选按钮组件",
  examples: [
    {
      title: "flexi-radio-button",
      render: function (): any {
