...
export default {
  displayName: "SyanImagePickerDemo",
  framework: "React",
  category: "UI",
  title: "SyanImagePickerDemo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-syan-image-picker.md",
  description: "React-Native 多图片选择器，支持裁剪与压缩",
  examples: [
    {
      title: "syan-image-picker",
      render: function (): any {
        return <App />;
      },
    },
