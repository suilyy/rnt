...
export default {
  displayName: "ImageResizerDemo",
  framework: "React",
  category: "UI",
  title: "ImageResizerDemo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/bam-tech-react-native-image-resizer.md",
  description: "图片裁剪",
  examples: [
    {
      title: "ImageResizer",
