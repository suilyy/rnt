...
export default {
  displayName: "LinearGradientDemo",
  framework: "React",
  category: "UI",
  title: "LinearGradient",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-linear-gradient.md",
  description: "提供颜色渐变效果",
  examples: [
    {
