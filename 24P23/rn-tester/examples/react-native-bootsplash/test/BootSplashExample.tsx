...
// 使用 export 导出
export const displayName = "BootSplashExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-bootsplash";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-bootsplash";
export const description = "Simple React Native bootsplash component.";

export const examples = [
  {
    title: "Bootsplash with default styling",
    render: function (): any {
      return <BootSplashTest />;
    },
  },
];
