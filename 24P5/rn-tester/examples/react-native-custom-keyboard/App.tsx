...
import {  
  ...
  uninstall,  
} from '@react-native-oh-tpl/react-native-custom-keyboard';  
...
export const displayName = 'react-native-custom-keyboard'; 
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-custom-keyboard';
export const documentationURL = 'https://github.com/react-native-oh-library/RNOHDCS/tree/main/react-native-custom-keyboard';
export const description = 'React Native custom keyboard';
export const examples = [
    {
      title: 'React Native custom keyboard',
      render: function (): any {
        return <App />;
      },
    },
