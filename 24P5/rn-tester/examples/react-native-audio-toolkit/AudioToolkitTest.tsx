...
class AudioToolkitTest extends Component<Props, State> {
...
export const displayName = 'react-native-audio-toolkit'; 
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-audio-toolkit';
export const documentationURL = 'https://github.com/react-native-oh-library/RNOHDCS/tree/main/react-native-audio-toolkit';
export const description = 'React Native audio toolkit';
export const examples = [
    {
      title: 'React Native audio toolkit',
      render: function (): any {
        return <AudioToolkitTest/>;
      },
    },
  ];