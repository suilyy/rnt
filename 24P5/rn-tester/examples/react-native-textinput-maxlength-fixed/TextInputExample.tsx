...
import { multiply } from '@react-native-oh-tpl/react-native-textinput-maxlength-fixed';
...
export const displayName = 'ReactNativeTextinputMaxlengthFixed';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-textinput-maxlength-fixed';
export const documentationURL = 'https://reactnative.dev/docs/button';
export const description = 'React Native Textinput Maxlength Fixed';

export const examples = [
  {
    title: 'react-native-textinput-maxlength-fixed',
    render: function (): any {
