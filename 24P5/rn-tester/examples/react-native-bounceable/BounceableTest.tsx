...
export const displayName = 'ReactNativeBounceable';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-bounceable';
export const documentationURL = 'https://reactnative.dev/docs/button';
export const description = 'React Native Bounceable';

export const examples = [
  {
    title: 'react-native-bounceable',
    render: function (): any {
      return <BounceableTest />;
    },
  },
];