...
export const displayName = 'react-native-community/datetimepicker';
export const framework = 'React';
export const category = 'basic';
export const title = 'react-native-community/datetimepicker';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-community-datetimepicker.md';
export const description = 'react-native-community/datetimepicker';

export const examples = [
    {
        title: 'react-native-community/datetimepicker',
        render: function (): any {
            return <DateTimePickerTestDemo />;
        },
    },
];
