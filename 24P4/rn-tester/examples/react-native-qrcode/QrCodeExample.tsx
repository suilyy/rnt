...
export const displayName = 'QrCodeExamle';
export const framework = 'React';
export const category = 'basic';
export const title = 'QrCodeExamle';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-qrcode.md';
export const description = 'react-native-qrcode';
