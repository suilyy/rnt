...
export const displayName = 'FsTest';
export const framework = 'React';
export const category = 'basic';
export const title = 'FsTest';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-fs.md';
export const description = 'FsTest';
