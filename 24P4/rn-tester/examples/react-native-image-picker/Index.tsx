...
export const title = 'ImagePickerTest';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-image-picker.md';
export const description = 'ImagePickerTest';

export const examples = [
    {
        title: 'ImagePickerTest',
        render: function (): any {
