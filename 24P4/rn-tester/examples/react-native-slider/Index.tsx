...
export const displayName = 'react-native-slider';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-slider';
export const documentationURL = 'https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-slider.md';
export const description = 'react-native-slider';
