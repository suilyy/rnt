...
export const displayName = "ReactNativeBarcodeBuilder";
export const framework = "React";
export const category = "UI";
export const title = "react-native-barcode-builder";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-barcode-builder";
export const description = "React Native Barcode Builder";

export const examples = [
    {
        title: "react-native-barcode-builder",
        render: function (): any {
            return <BarcodeBuilderExample />;
        },
    },
];