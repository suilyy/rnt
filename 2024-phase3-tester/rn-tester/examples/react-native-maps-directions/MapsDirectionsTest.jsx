...
export const displayName = 'ReactNativeMapsDirections';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-maps-directions';
export const documentationURL = 'https://github.com/react-native-oh-library/react-native-maps-directions';
export const description = 'React Native Maps Directions';

export const examples = [
  {
    title: 'react-native-maps-directions',
    render: function (): any {
      return <MapsDirectionsTest />;
    },
  },
];
