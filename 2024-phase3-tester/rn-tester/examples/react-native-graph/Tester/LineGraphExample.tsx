...
export const displayName = 'ReactNativeGraph';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-graph';
export const documentationURL = 'https://github.com/margelo/react-native-graph';
export const description = 'React Native Graph';

export const examples = [
  {
    title: 'react-native-graph',
    render: function (): any {
      return <LineGraphExample />;
    },
  },
];