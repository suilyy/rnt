...
export const displayName = "AutoLinkExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-autolink";
export const documentationURL = "https://github.com/joshswan/react-native-autolink";
export const description = "React Native Autolink";

export const examples = [
    {
        title: "react-native-autolink",
        render: function (): any {
            return <AutoLinkExample />;
        },
    },
];