...
export const displayName = "OpSqlite";
export const framework = "React";
export const category = "UI";
export const title = "op-sqlite";
export const documentationURL = "https://github.com/react-native-oh-library/op-sqlite";
export const description = "Op Sqlite";
