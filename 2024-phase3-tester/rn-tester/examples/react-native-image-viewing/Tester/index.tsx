...
export const displayName = "ReactNativeImageViewing";
export const framework = "React";
export const category = "UI";
export const title = "react-native-image-viewing";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-image-viewing";
export const description = "React Native Image Viewing";

export const examples = [
    {
        title: "react-native-image-viewing",
        render: function (): any {
            return <ImageViewingTester />;
        },
    },
];