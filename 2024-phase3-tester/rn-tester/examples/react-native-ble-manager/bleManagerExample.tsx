...
export const displayName = 'BleManagerDemos';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-ble-manager';
export const documentationURL = 'https://github.com/react-native-oh-library/react-native-ble-manager';
export const description = 'React Native Ble Manager';

export const examples = [
  {
    title: 'react-native-ble-manager',
    render: function (): any {
      return <BleManagerDemos />;
    },
  },
];