...
export const displayName = "ReactNativeNotifier";
export const framework = "React";
export const category = "UI";
export const title = "react-native-notifier";
export const documentationURL = "https://github.com/seniv/react-native-notifier";
export const description = "React Native Notifier";
