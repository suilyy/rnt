...
export const displayName = "ReactNativeMarkdownRenderer";
export const framework = "React";
export const category = "UI";
export const title = "react-native-markdown-renderer";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-markdown-renderer";
export const description = "React Native Markdown Renderer";

export const examples = [
  {
    title: "react-native-markdown-renderer",
    render: function (): any {
      return <TestReactNativeMarkdownRendererDemo filter={{}}/>;
    },
  },
];
