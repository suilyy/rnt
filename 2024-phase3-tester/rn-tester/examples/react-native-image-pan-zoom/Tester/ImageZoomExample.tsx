...
export const displayName = "ReactNativeImagePanZoom";
export const framework = "React";
export const category = "UI";
export const title = "react-native-image-pan-zoom";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-image-zoom";
export const description = "React Native Image Pan Zoom";
