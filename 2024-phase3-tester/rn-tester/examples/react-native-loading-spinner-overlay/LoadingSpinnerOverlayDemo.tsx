...
export default function LoadingSpinnerOverlayDemo() {
...
export const displayName = "ReactNativeLoadingSpinnerOverlay";
export const framework = "React";
export const category = "UI";
export const title = "react-native-loading-spinner-overlay";
export const documentationURL = "https://github.com/ladjs/react-native-loading-spinner-overlay";
export const description = "React Native Loading Spinner Overlay";

export const examples = [
  {
    title: "react-native-loading-spinner-overlay",
    render: function (): any {
      return <LoadingSpinnerOverlayDemo />;
    },
  },
];