...
export const displayName = "ReactNavigationHeaderButtons";
export const framework = "React";
export const category = "UI";
export const title = "react-navigation-header-buttons";
export const documentationURL = "https://github.com/vonovak/react-navigation-header-buttons";
export const description = "React Navigation Header Buttons";

export const examples = [
  {
    title: "react-navigation-header-buttons",
    render: function (): any {
      return <HeaderButtonExample />;
    },
  },
];
