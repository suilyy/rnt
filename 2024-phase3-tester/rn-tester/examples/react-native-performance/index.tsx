import { Tester, Filter, TestSuite, LogicalTestCase, TestCase as _TestCase } from '@rnoh/testerino';
...
function Button({ label, onPress }: { onPress: () => void; label: string }) {
  return (
    <TouchableHighlight
      ...
      onPress={onPress}>
      <Text style={{ color: 'black', fontWeight: 'bold', fontSize: 12 }}>{label}</Text>
    </TouchableHighlight>
  );
}
type TesterTag = 'dev';
...
function prepareHarmonySkipProp(skipProp: TesterHarmonySkipProp): string | boolean {
...
function Logical({
  ...
  return <_TestCase itShould={itShould} skip={prepareSkipProp(skip)} tags={tags} fn={fn} />;
}
...
export const displayName = 'ReactNativePerformanceExample';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-performance';
export const documentationURL = 'https://github.com/oblador/react-native-performance';
export const description = 'React Native Performance';

export const examples = [
  {
    title: 'react-native-performance',
    render: function (): any {
      return <TestNativePerformanceDemo />;
    },
  },
];
