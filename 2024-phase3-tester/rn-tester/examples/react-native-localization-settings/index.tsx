  ...
  return (
    <Tester>
      <TestSuite name="ReactNativeLanguageDetector">
        <TestCase tags={['C_API']} itShould="ReactNativeLanguageDetector(依赖i18的场景)">
...
export const displayName = 'ReactNativeLocalizationSettingsExample';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-localization-settings';
export const documentationURL = 'https://github.com/jakex7/react-native-localization-settings';
export const description = 'React Native Localization Settings';

export const examples = [
  {
    title: 'react-native-localization-settings',
    render: function (): any {
