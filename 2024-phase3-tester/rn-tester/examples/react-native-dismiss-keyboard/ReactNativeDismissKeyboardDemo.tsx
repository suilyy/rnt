...
export const displayName = "ReactNativeDismissKeyboard";
export const framework = "React";
export const category = "UI";
export const title = "react-native-dismiss-keyboard";
export const documentationURL = "https://github.com/DanielMSchmidt/react-native-dismiss-keyboard";
export const description = "React Native Dismiss Keyboard";

export const examples = [
  {
    title: "react-native-autocomplete-input",
    render: function (): any {
      return <ReactNativeDismissKeyboardExample />;
    },
  },
];
