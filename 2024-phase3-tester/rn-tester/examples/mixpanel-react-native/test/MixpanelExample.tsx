...
export const displayName = "MixpanelReactNative";
export const framework = "React";
export const category = "UI";
export const title = "mixpanel-react-native";
export const documentationURL = "https://github.com/react-native-oh-library/mixpanel-react-native";
export const description = "Mixpanel React Native";

export const examples = [
  {
    title: "mixpanel-react-native",
    render: function (): any {
      return <MixpanelExample />;
    },
  },
];