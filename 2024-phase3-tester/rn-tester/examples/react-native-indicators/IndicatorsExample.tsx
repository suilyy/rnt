...
export const displayName = "IndicatorsExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-indicators";
export const documentationURL = "https://github.com/n4kz/react-native-indicators";
export const description = "React Native Indicators";

export const examples = [
  {
    title: "react-native-indicators",
    render: function (): any {
      return <IndicatorsExample />;
    },
  },
];
