...
export const displayName = "ReactNavigationBottomSheet";
export const framework = "React";
export const category = "UI";
export const title = "react-navigation-bottom-sheet";
export const documentationURL = "https://github.com/th3rdwave/react-navigation-bottom-sheet";
export const description = "React Navigation Bottom Sheet";

export const examples = [
  {
    title: "react-navigation-bottom-sheet",
    render: function (): any {
