...
export const displayName = "AutoCompleteInputExample";
export const framework = "React";
export const category = "UI";
export const title = "react-native-autocomplete-input";
export const documentationURL = "https://github.com/byteburgers/react-native-autocomplete-input";
export const description = "React Native Auto complete Input";
