...
export const displayName = "ReactNativeWalkthroughTooltip";
export const framework = "React";
export const category = "UI";
export const title = "react-native-walkthrough-tooltip";
export const documentationURL = "https://github.com/jasongaare/react-native-walkthrough-tooltip";
export const description = "React Native Walkthrough Tooltip";
