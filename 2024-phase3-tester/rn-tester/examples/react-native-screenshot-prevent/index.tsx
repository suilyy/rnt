import { Tester, Filter, TestSuite, TestCase as _TestCase } from '@rnoh/testerino';
...
function Example({
  ...
  return (
    <_TestCase itShould={itShould} modal={modal} tags={tags} skip={prepareSkipProp(skip)}>
      {children}
    </_TestCase>
  );
}
        ...
        <TestSuite name="React Native Screenshot Prevent">
          <TestCase.Example itShould="测试enabled(true)方法">
            <View style={styles.inputpart}>
              <Button title="点击测试enable,开启禁止截屏与录屏功能" onPress={handleClick1}></Button>
            </View>
          </TestCase.Example>
          <TestCase.Example itShould="测试enabled(false)方法">
            <View style={styles.inputpart}>
              <Button title="点击测试enable,关闭禁止截屏与录屏功能" onPress={handleClick2}></Button>
            </View>
          </TestCase.Example>
          <TestCase.Example itShould="测试addListener方法1">
            <View style={styles.inputpart}>
              <Button title="点击测试addListener,开启截屏监听" onPress={handleClick3}></Button>
            </View>
          ...
          <TestCase.Example itShould="测试addListener方法2">
            <View style={styles.inputpart}>
              <Button title="点击测试addListener,关闭截屏监听" onPress={handleClick4}></Button>
            </View>
          </TestCase.Example>
        </TestSuite>
      </ScrollView>
...
export const displayName = 'ReactNativeScreenshotPreventExample';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-screenshot-prevent';
export const documentationURL = 'https://github.com/killserver/react-native-screenshot-prevent';
export const description = 'React Native Screenshot Prevent';

export const examples = [
  {
    title: 'react-native-screenshot-prevent',
    render: function (): any {
      return <TestNativeScreenshotPreventDemo />;
    },
  },
];
