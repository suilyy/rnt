...
export const displayName = "ReactNativeCopilot";
export const framework = "React";
export const category = "UI";
export const title = "react-native-copilot";
export const documentationURL = "https://github.com/mohebifar/react-native-copilot";
export const description = "React Native Copilot";
