...
export const displayName = 'SafeModuleExample';
export const framework = 'React';
export const category = 'Basic';
export const title = 'react-native-safe-modules';
export const documentationURL = 'https://github.com/emilioicai/react-native-safe-modules';
export const description = 'React Native Safe Modules';

export const examples = [
  {
    title: 'react-native-safe-modules',
    render: function () {
      return <SafeModuleExample />;
    },
  },
];
