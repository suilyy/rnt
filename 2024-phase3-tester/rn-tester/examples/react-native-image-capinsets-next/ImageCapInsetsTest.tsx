...
export const displayName = "ReactNativeImageCapinsetsNext";
export const framework = "React";
export const category = "UI";
export const title = "react-native-image-capinsets-next";
export const documentationURL = "https://github.com/react-native-oh-library/react-native-image-capinsets-next";
export const description = "React Native Image Capinsets Next";

export const examples = [
    {
        title: "react-native-image-capinsets-next",
        render: function (): any {
            return <YourImage />;
        },
    },
