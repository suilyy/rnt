...
function ReactNativeStepIndicator() {
...
export const displayName = 'react-native-step-indicator';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-step-indicator';
export const documentationURL = 'https://reactnative.dev/docs/button';
export const description = 'react-native-step-indicator';

export const examples = [
  {
    title: 'ReactNativeStepIndicator',
    render: function (): any {
      return <ReactNativeStepIndicator />;
    },
  },
];