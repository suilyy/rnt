...
export const displayName = "ReactNativeRecaptchaThatWorks";
export const framework = "React";
export const category = "UI";
export const title = "react-native-recaptcha-that-works";
export const documentationURL = "https://github.com/douglasjunior/react-native-recaptcha-that-works";
export const description = "React Native Recaptcha That Works";
