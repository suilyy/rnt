...
export const displayName = 'ReactNativeThemeControl';
export const framework = 'React';
export const category = 'UI';
export const title = 'react-native-theme-control';
export const documentationURL = 'https://github.com/react-native-oh-library/react-native-theme-control';
export const description = 'React Native Theme Control';

export const examples = [
  {
    title: 'react-native-theme-control',
    render: function (): any {
      return <ThemeControlTest />;
    },
  },
];
