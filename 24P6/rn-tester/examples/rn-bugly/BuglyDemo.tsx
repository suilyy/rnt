...
class BuglyExample extends React.Component {
...
export default {
  displayName: "RNBuglyDemo",
  framework: "React",
  category: "Tools",
  title: "RNBuglyDemo",
  documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/rn-bugly.md",
  description: "强大的移动应用崩溃监控和分析平台",
  examples: [
    {
      title: "rn-bugly",
      render: function (): any {
