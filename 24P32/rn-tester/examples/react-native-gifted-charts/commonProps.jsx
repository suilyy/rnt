...
export const commonPointerProps = [
  ...
  { pointerConfig: { pointerColor: 'blue' ,persistPointer: true,} },
  { pointerConfig: { showPointerStrip: true }, },
   { pointerConfig: { showPointerStrip: false }, },
  { pointerConfig: { pointerStripWidth: 10,pointerStripHeight: 10,pointerStripColor: 'blue',stripBehindBars: false,persistPointer: true,}, },
   { pointerConfig: { pointerStripWidth: 20,pointerStripHeight: 10,pointerStripColor: 'blue',stripBehindBars: false,persistPointer: true,}, },
  { pointerConfig: { pointerStripWidth: 10,pointerStripHeight: 10 ,persistPointer: true,}, }, 
  { pointerConfig: {pointerStripWidth: 10, pointerStripHeight: 20,persistPointer: true,}, },
  { pointerConfig: { pointerStripColor: 'green',persistPointer: true, }, }, 
  { pointerConfig: { pointerStripColor: 'blue' ,persistPointer: true,}, },
  { pointerConfig: { pointerStripUptoDataPoint: true,persistPointer: true, }, },
   { pointerConfig: { pointerStripUptoDataPoint: false,persistPointer: true,}, },
  { pointerConfig: { stripOverPointer: true, stripBehindBars: false, pointerStripColor: 'blue' ,persistPointer: true,}, }, 
  { pointerConfig: { stripOverPointer: false, stripBehindBars: false, pointerStripColor: 'blue' ,persistPointer: true,}, },
  { pointerConfig: { pointerVanishDelay: 3000,}, }, 
  { pointerConfig: { pointerVanishDelay: 10000,}, },
  { pointerConfig: { activatePointersOnLongPress: true ,persistPointer: true,}, },
   { pointerConfig: { activatePointersOnLongPress: false ,persistPointer: true,}, },
  { pointerConfig: { persistPointer: true, }, },
  { pointerConfig: { persistPointer: false, }, },
  { pointerConfig: { strokeDashArray: [10, 20] ,persistPointer: true,} },
   { pointerConfig: { strokeDashArray: [10, 40] ,persistPointer: true,} },
]