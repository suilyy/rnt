...
export default function () {
  ...
  const populationPyramidProp = [
    ...
    {leftBarBorderColor: 'red',leftBarBorderWidth: 2,showMidAxis: true ,width:350},
    {leftBarBorderColor: 'black',leftBarBorderWidth: 2,showMidAxis: true ,width:350},
    ...
    {allCornersRounded: false,barBorderRadius: 5,showMidAxis: true ,width:350},
    {allCornersRounded: true,barBorderRadius: 5,showMidAxis: true ,width:350},
    ...
    {leftSurplusBorderColor: 'red',leftSurplusBorderWidth:2, showSurplusLeft: true,showMidAxis: true ,width:350},
    {leftSurplusBorderColor: 'blue',leftSurplusBorderWidth:2, showSurplusLeft: true,showMidAxis: true ,width:350},
    ...
    {rightSurplusBorderColor: 'red',rightSurplusBorderWidth: 2, showSurplusRight: true,showMidAxis: true ,width:350},
    {rightSurplusBorderColor: 'blue',rightSurplusBorderWidth: 2, showSurplusRight: true,showMidAxis: true ,width:350},
